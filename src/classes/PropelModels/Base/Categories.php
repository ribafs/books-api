...
abstract class Categories implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\PropelModels\\Map\\CategoriesTableMap';
    ...
    /**
     * Initializes internal state of PropelModels\Base\Categories object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\PropelModels\Categories The current object (for fluent API support)
     */
    ...
    public function setCategory($v)
    {
        ...
        if ($this->category !== $v) {
            $this->category = $v;
            $this->modifiedColumns[CategoriesTableMap::COL_CATEGORY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CategoriesTableMap::translateFieldName('Category', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\PropelModels\\Categories'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CategoriesTableMap::COL_CATEGORY)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\PropelModels\Categories
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\PropelModels\Categories The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CategoriesTableMap::COL_CATEGORY)) {
            $criteria->add(CategoriesTableMap::COL_CATEGORY, $this->category);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PropelModels\Categories (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PropelModels\Categories Clone of current object.
     * @throws PropelException
     */
    ...
    public function setBooksByCategoriess(Collection $booksByCategoriess, ConnectionInterface $con = null)
    {
        ...
        foreach ($booksByCategoriessToDelete as $booksByCategoriesRemoved) {
            $booksByCategoriesRemoved->setCategories(null);
        }
    ...
    protected function doAddBooksByCategories(ChildBooksByCategories $booksByCategories)
    {
        ...
        $booksByCategories->setCategories($this);
    }
    ...
    public function removeBooksByCategories(ChildBooksByCategories $booksByCategories)
    {
        if ($this->getBooksByCategoriess()->contains($booksByCategories)) {
            ...
            $booksByCategories->setCategories(null);
        }
     ...
     * @return ObjectCollection|ChildBooksByCategories[] List of ChildBooksByCategories objects
     */
    public function getBooksByCategoriessJoinBooks(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildBooksByCategoriesQuery::create(null, $criteria);
