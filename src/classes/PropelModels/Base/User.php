...
abstract class User implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\PropelModels\\Map\\UserTableMap';
    ...
    /**
     * Initializes internal state of PropelModels\Base\User object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\PropelModels\User The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\PropelModels\\User'), 0, $e);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\PropelModels\User The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PropelModels\User (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PropelModels\User Clone of current object.
     * @throws PropelException
     */
    ...
    public function setBooksByUsers(Collection $booksByUsers, ConnectionInterface $con = null)
    {
        ...
        foreach ($booksByUsersToDelete as $booksByUserRemoved) {
            $booksByUserRemoved->setUser(null);
        }
     ...
     * @return ObjectCollection|ChildBooksByUser[] List of ChildBooksByUser objects
     */
    public function getBooksByUsersJoinBooks(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildBooksByUserQuery::create(null, $criteria);
