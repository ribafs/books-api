 ...
 */
abstract class Authors implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\PropelModels\\Map\\AuthorsTableMap';
    ...
    /**
     * Initializes internal state of PropelModels\Base\Authors object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>Authors</code> instance.  If
     * <code>obj</code> is an instance of <code>Authors</code>, delegates to
     * <code>equals(Authors)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Authors The current object, for fluid interface
     */
     ...
     * @return $this|\PropelModels\Authors The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[AuthorsTableMap::COL_ID] = true;
        }
    ...
    public function setFirstname($v)
    {
        ...
        if ($this->firstname !== $v) {
            $this->firstname = $v;
            $this->modifiedColumns[AuthorsTableMap::COL_FIRSTNAME] = true;
        }
    ...
    public function setLastname($v)
    {
        ...
        if ($this->lastname !== $v) {
            $this->lastname = $v;
            $this->modifiedColumns[AuthorsTableMap::COL_LASTNAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AuthorsTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AuthorsTableMap::translateFieldName('Firstname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->firstname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AuthorsTableMap::translateFieldName('Lastname', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = AuthorsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\PropelModels\\Authors'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAuthorsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Authors::setDeleted()
     * @see Authors::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAuthorsQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AuthorsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[AuthorsTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . AuthorsTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(AuthorsTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(AuthorsTableMap::COL_FIRSTNAME)) {
            $modifiedColumns[':p' . $index++]  = 'firstname';
        }
        if ($this->isColumnModified(AuthorsTableMap::COL_LASTNAME)) {
    ...
    {
        $pos = AuthorsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Authors'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Authors'][$this->hashCode()] = true;
        $keys = AuthorsTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\PropelModels\Authors
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\PropelModels\Authors The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(AuthorsTableMap::DATABASE_NAME);

        if ($this->isColumnModified(AuthorsTableMap::COL_ID)) {
            $criteria->add(AuthorsTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(AuthorsTableMap::COL_FIRSTNAME)) {
            $criteria->add(AuthorsTableMap::COL_FIRSTNAME, $this->firstname);
        }
        if ($this->isColumnModified(AuthorsTableMap::COL_LASTNAME)) {
            $criteria->add(AuthorsTableMap::COL_LASTNAME, $this->lastname);
        }
    ...
    {
        $criteria = ChildAuthorsQuery::create();
        $criteria->add(AuthorsTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PropelModels\Authors (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PropelModels\Authors Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildAuthors is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildAuthors The current object (for fluent API support)
     */
    public function setBooksByAuthorss(Collection $booksByAuthorss, ConnectionInterface $con = null)
    {
        ...
        foreach ($booksByAuthorssToDelete as $booksByAuthorsRemoved) {
            $booksByAuthorsRemoved->setAuthors(null);
        }
    ...
    protected function doAddBooksByAuthors(ChildBooksByAuthors $booksByAuthors)
    {
        ...
        $booksByAuthors->setAuthors($this);
    }
    ...
    public function removeBooksByAuthors(ChildBooksByAuthors $booksByAuthors)
    {
        if ($this->getBooksByAuthorss()->contains($booksByAuthors)) {
            ...
            $booksByAuthors->setAuthors(null);
        }
     ...
     * Otherwise if this Authors is new, it will return
     * an empty collection; or if this Authors has previously
     * been saved, it will retrieve related BooksByAuthorss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Authors.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildBooksByAuthors[] List of ChildBooksByAuthors objects
     */
    public function getBooksByAuthorssJoinBooks(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildBooksByAuthorsQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(AuthorsTableMap::DEFAULT_STRING_FORMAT);
    }
