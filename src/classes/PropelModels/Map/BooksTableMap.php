...
class BooksTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'PropelModels.Map.BooksTableMap';
     ...
     */
    const OM_CLASS = '\\PropelModels\\Books';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'PropelModels.Books';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Title', 'Year', ),
        self::TYPE_CAMELNAME     => array('id', 'title', 'year', ),
        self::TYPE_COLNAME       => array(BooksTableMap::COL_ID, BooksTableMap::COL_TITLE, BooksTableMap::COL_YEAR, ),
        self::TYPE_FIELDNAME     => array('id', 'title', 'year', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Title' => 1, 'Year' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'title' => 1, 'year' => 2, ),
        self::TYPE_COLNAME       => array(BooksTableMap::COL_ID => 0, BooksTableMap::COL_TITLE => 1, BooksTableMap::COL_YEAR => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'title' => 1, 'year' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\PropelModels\\Books');
        $this->setPackage('PropelModels');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('title', 'Title', 'VARCHAR', true, 500, '');
        $this->addColumn('year', 'Year', 'INTEGER', true, null, 1970);
    } // initialize()
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('BooksByCategories', '\\PropelModels\\BooksByCategories', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':id_book',
    1 => ':id',
  ),
), null, null, 'BooksByCategoriess', false);
        $this->addRelation('BooksByUser', '\\PropelModels\\BooksByUser', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':id_book',
    1 => ':id',
  ),
), 'CASCADE', 'CASCADE', 'BooksByUsers', false);
    } // buildRelations()
    /**
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(BooksTableMap::COL_TITLE);
            $criteria->addSelectColumn(BooksTableMap::COL_YEAR);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \PropelModels\Books) { // it's a model object
