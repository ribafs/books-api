...
use PropelModels\Categories;
use PropelModels\CategoriesQuery;
...
class CategoriesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'PropelModels.Map.CategoriesTableMap';
     ...
     */
    const OM_CLASS = '\\PropelModels\\Categories';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'PropelModels.Categories';
     ...
     */
    const COL_CATEGORY = 'categories.category';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Category', ),
        self::TYPE_CAMELNAME     => array('id', 'category', ),
        self::TYPE_COLNAME       => array(CategoriesTableMap::COL_ID, CategoriesTableMap::COL_CATEGORY, ),
        self::TYPE_FIELDNAME     => array('id', 'category', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Category' => 1, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'category' => 1, ),
        self::TYPE_COLNAME       => array(CategoriesTableMap::COL_ID => 0, CategoriesTableMap::COL_CATEGORY => 1, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'category' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\PropelModels\\Categories');
        $this->setPackage('PropelModels');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('category', 'Category', 'VARCHAR', true, 250, '');
    } // initialize()
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CategoriesTableMap::COL_CATEGORY);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \PropelModels\Categories) { // it's a model object
